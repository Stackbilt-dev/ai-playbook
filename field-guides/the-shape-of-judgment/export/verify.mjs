...
console.log(JSON.stringify({ version: release.version, sourceSections: (html.match(/data-source=/g) ?? []).length, epubFiles: Object.keys(epub.files).length, pdfBytes: pdf.byteLength }, null, 2));
